...
export const {requestDeletetHoliday,deleteHolidaySuccess,deleteHolidayFailure,
    requestInsertHoliday,insertHolidaySuccess,insertHolidayFailure,requestHoliday,getHolidaySuccess,getHolidayFailure,requestUpdateHoliday,updateHolidaySuccess,updateHolidayFailure}=slice.actions;
// ----------------------------------------------------------------------
