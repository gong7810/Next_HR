...
import { Avatar, Box, Button, CardActions, CardContent, Divider, FormControl, Grid, InputLabel, MenuItem, Select, Stack, TextField, Typography } from '@mui/material';
...
const BreakAttendancePage = () => {
  ...
  const empList = selectData.map(
    (e) => {
      return <MenuItem value={e.empCode} key={e.empCode}>{e.empName}</MenuItem>
    }
  )
  const insertEXAttd = () => {
    ...
    axios.post("http://localhost:9101/attdmgmt/excused-attnd",
      {
  ...
  function calculateNumberOfDays() {
    ...
    if (restTypeName === "오전반차" || restTypeName === "오후반차")
      setNumberOfDays(0.5);
    else
              ...
              <Grid item xs={12}>
                <CardContent>
                  <Grid container spacing={gridSpacing}>
                        ...
                        <FormControl fullWidth>
                          ...
                          <Select
                            ...
                            onChange={(event) => {
                              ...
                              if (event.target.value == "공가") { setRestTypeCode("ASC001"); }
                              ...
                              else if (event.target.value == "병가") { setRestTypeCode("ASC004"); }
                            }}
                          >
                    ...
                    <Grid item xs={12} sm={6}>
                      <TextField fullWidth label="신청사유" onChange={(event) => { setCause(event.target.value) }} />
                    </Grid>
                  </Grid>
                </CardContent>
              </Grid>
