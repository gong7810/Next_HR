	...
	<div class="container">
		<nav>
			<div class="nav nav-tabs" id="nav-tab" role="tablist">
				<a class="nav-item nav-link active" data-toggle="tab" href="#employmentRequest_tab" role="tab" aria-controls="nav-home" aria-selected="true"> 증빙서류 신청</a> 
				<a class="nav-item nav-link" data-toggle="tab" href="#employmentList_tab" role="tab" aria-controls="nav-profile" aria-selected="false">증빙서류 조회</a>
			</div>
		</nav>
	</div>

	<div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
		<div class="tab-pane fade show active" id="employmentRequest_tab" role="tabpanel" aria-labelledby="nav-home-tab">
			...
			<table style="margin : auto;">
				...
				<tr>
					...
					<form id="proof_img_form" action="${pageContext.request.contextPath}/systemmgmt/proofImg.do" enctype="multipart/form-data" method="post">
						...
						<button type="button" style="width: 150px" class="ui-button ui-idget ui-corner-all" id="findfile">영수증</button>
		...
		<div class="tab-pane fade" id="employmentList_tab" role="tabpanel" aria-labelledby="nav-profile-tab">
			<table>
				...
				<tr>
					<td colspan="2">
						<center>
							<button class="ui-button ui-widget ui-corner-all" id="search_proofAttdList_Btn">조회하기</button>
