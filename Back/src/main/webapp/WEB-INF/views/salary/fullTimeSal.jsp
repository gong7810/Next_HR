...
var month;
	...
	/* 코드선택 창 띄우기 */
	function getCode() { PopW=window.open("${pageContext.request.contextPath}/comm/agWindow/view","payment_date","width=400,height=400,top=10,left=20,resizable=no,scrollbars=yes,menubar=yes,toolbar=no,status=yes,location=yes") }
...
<div class="container2 wow fadeInDown" >
  ...
  <div class="payday" style="border: 1px solid grey;">
    	지급일 <input type="text" id="payment_ord" readonly/> <input type="button" value=&#128270 id="payment_date">  <input type="text" value="" id="payment_value" readonly/>
  </div>
  ...
  <div class="grid_div" style="border: 1px solid grey; ">
    ...
    <div class="inwon" style="position: relative;">
    	<div style="border:1px solid grey; padding:10px; position: absolute; bottom:0px;">총 인원 : <span id="humanSu">0</span> 명</div>
    </div>
  ...
  <div class="tax_div" style="border: 1px solid grey;">
    ...
    <div class="company" style="border: 1px solid grey; position: relative;">
      		<table class="tg" style="position: absolute;">
				...
				<div style="border:1px solid grey; padding:10px; position: absolute; bottom:0px;">회사부담금 총액 : <span id="companybudam_total"></span></div>
    </div> 
  </div>
  <div class="textarea" style="border: 1px solid grey;">
		    ...
		    <div class="container3">		
				...
				사업장 &nbsp;&nbsp;<input type="text" class="css-input" />&emsp;&emsp; 급여형태 &nbsp;&nbsp;<input type="text" class="css-input" id="t1st" readonly/>&emsp;&emsp; 과세총액 &nbsp;&nbsp;<input type="text" class="css-input" id="t1tt" />&emsp;&emsp; 소득제외 &nbsp;&nbsp;<input type="text" class="css-input" /> <br/><br/>
				&emsp; 부서 &nbsp;&nbsp;<input type="text" class="css-input" id="t1dept"/>&emsp;&emsp; 입사일자 &nbsp;&nbsp;<input type="text" class="css-input" id="t1hd" />&emsp;&emsp; 비과세신고분 &nbsp;&nbsp;<input type="text" class="css-input" value="0" />&emsp;&emsp; 회사부담금 &nbsp;&nbsp;<input type="text" class="css-input" id="t1bc" /> <br/><br/>
				&emsp;&emsp;&emsp; 직종 &nbsp;&nbsp;<input type="text" class="css-input" id="t1job" />&emsp;&emsp; 퇴사일자 &nbsp;&nbsp;<input type="text" class="css-input" />&emsp;&emsp; 비과세신고제외분 &nbsp;&nbsp;<input type="text" class="css-input" value="0" />&emsp;&emsp; 차인지급액 &nbsp;&nbsp;<input type="text" class="css-input" id="t1as" /> 		
				...
				비과세 &nbsp;&nbsp;<input type="text" class="css-input" value="0" readonly/>&emsp;&emsp; 회사부담금 &nbsp;&nbsp;<input type="text" class="css-input" id="tab2bc" readonly/>&emsp;&emsp; 농특세 &nbsp;&nbsp;<input type="text" class="css-input" readonly/>&emsp;&emsp; 건강보험 &nbsp;&nbsp;<input type="text" class="css-input" id="tab2hi" readonly/> / &nbsp;&nbsp;<input type="text" id="tab2hi2" class="css-input" readonly/>				
				</div>		
			</div>			
  </div>
