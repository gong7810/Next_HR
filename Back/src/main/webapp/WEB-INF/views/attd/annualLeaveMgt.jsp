...
<script>
   ...
   $(document).ready(function() {
      ...
      $("#searchYear").change(function(){document.getElementById("searchButton").disabled = false;}); //searchYear 셀렉터에 변화가 감지되면 searchButton의 disable상태를 해제합니다 
      $("#searchMonth").change(function(){document.getElementById("searchButton").disabled = false;}); //searchMonth 셀렉터에 변화가 감지되면 searchButton의 disable상태를 해제합니다 
   ...
   function finalizeAnnualVacationMgt(){
      ...
      $.ajax({
    	 type : "PUT",
         url : "${pageContext.request.contextPath}/attdappvl/annual-leaveMgt/1",
         data : {
            "sendData" : sendData
         },
         dataType : "json",
   ...
   function cancelAnnualVacationMgt(){
      ...
      $.ajax({
    	 type : "PUT",
         url : "${pageContext.request.contextPath}/attdappvl/annual-leaveMgt/2",
         data : {
            "sendData" : sendData
         },
         dataType : "json",
...
<body class="hm-gradient">
	<section id="tabs" style="width:950px; height:530px; text-align: center; padding:6px;" class="wow fadeInDown">
		...
		<div id="annualVacation_grid" style="height: 300px; width: 900px; margin : auto;" class="ag-theme-balham"></div>
	</section>
</body>
</html>